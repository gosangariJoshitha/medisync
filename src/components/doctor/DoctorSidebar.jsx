...
export default function Sidebar() {
    ...
    const menuItems = [
        ...
        { path: "/dashboard/doctor/add-patient", icon: <UserPlus size={20} />, label: "Add Patient" },
        { path: "/dashboard/doctor/view-patients", icon: <Users size={20} />, label: "View Patients" },
        { path: "/dashboard/doctor/monitor", icon: <Activity size={20} />, label: "Monitor Patients" },
        { path: "/dashboard/doctor/reports", icon: <BarChart2 size={20} />, label: "Reports" },
    ];
