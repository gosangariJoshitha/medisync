  ...
  return (
    <div className="fade-in">
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        <div>
          ...
          <div className="bg-gray-50 p-4 rounded border">
            ...
            <p>
              <strong>Age:</strong> {patientData.age} / {patientData.gender}
            </p>
            <p>
            ...
            {patientData.caretakerName && (
              <div className="mt-2 pt-2 border-t text-sm">
                <p>
                  <strong>Caretaker:</strong> {patientData.caretakerName}
                </p>
                <p>
                  <strong>Ph:</strong> {patientData.caretakerPhone}
                </p>
              </div>
            )}
          </div>
        ...
        <div>
          ...
          <div className="bg-gray-50 p-4 rounded border max-h-48 overflow-y-auto">
            {medicines.map((med, i) => (
              <div
                key={i}
                className="mb-2 pb-2 border-b last:border-0 last:pb-0"
              >
                ...
                <p className="text-sm text-muted">
                  {med.timeDisplay} | {med.durationValue} {med.durationUnit}
                </p>
              </div>
            ))}
          </div>
      ...
      <div className="text-center p-4 bg-yellow-50 rounded mb-6 text-sm text-yellow-800">
        <p>
          By clicking Finish, an account will be created for{" "}
          <strong>{patientData.fullName}</strong> with ID{" "}
          <strong>{patientData.patientId}</strong>.
        </p>
