        ...
        const checkAlarm = () => {
            ...
            medicines.forEach(med => {
                ...
                if (times.includes(currentTime)) {
                    ...
                    const seenAlarms = JSON.parse(localStorage.getItem('seenAlarms') || '[]');
        ...
        <div className="fixed bottom-4 right-4 z-50 animate-bounce">
            <div className="bg-red-600 text-white p-6 rounded-lg shadow-2xl flex flex-col items-center gap-4 border-4 border-white">
                ...
                <div className="text-center">
                    ...
                    <p className="text-lg">Time to take <br /><span className="font-bold text-yellow-300 text-xl">{alarmActive.medName}</span></p>
                </div>
                <button
