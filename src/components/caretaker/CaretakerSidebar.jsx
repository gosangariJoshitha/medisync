...
export default function CaretakerSidebar() {
  ...
  const menuItems = [
    ...
    {
      path: "/dashboard/caretaker/reports",
      icon: <FileText size={20} />,
      label: "Reports",
    },
    {
      path: "/dashboard/caretaker/notifications",
      icon: <Bell size={20} />,
      label: "Notifications",
    },
    {
      path: "/dashboard/caretaker/contact-doctor",
      icon: <Phone size={20} />,
      label: "Contact Doctor",
    },
    {
      path: "/dashboard/caretaker/book-appointment",
    ...
    >
      ...
      <div className="mt-auto p-4 bg-blue-50 rounded-lg">
        ...
        <p className="text-xs text-blue-600">
          Ensure your linked patients have their emergency contacts updated.
        </p>
      </div>
    </aside>
  );
