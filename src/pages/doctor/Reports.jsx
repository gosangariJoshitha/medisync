...
export default function Reports() {
  ...
  return (
    <div className="fade-in">
      ...
      <Motion.div
        whileHover={{ y: -2 }}
        className="card border-l-4 border-l-blue-500 mb-6"
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted mt-1">
              Overall clinic adherence has improved by <strong>5%</strong>{" "}
              compared to last week. However, <strong>Tuesday evenings</strong>{" "}
              show the highest rate of missed doses across all patients.
            ...
            <div className="flex gap-4 mt-4">
              ...
              <button className="text-primary text-sm font-semibold hover:underline flex items-center gap-1">
                <Share2 size={14} /> Share with Admin
              </button>
            </div>
          </div>
        </div>
