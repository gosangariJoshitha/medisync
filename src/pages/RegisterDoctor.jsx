            ...
            <div className="card">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="input-group">
                        ...
                        <input type="text" name="hospitalName" className="input" required value={formData.hospitalName} onChange={handleChange} />
                    </div>

                    <div className="input-group">
                        <label className="label">Specialization</label>
                        <input type="text" name="specialization" className="input" required value={formData.specialization} onChange={handleChange} />
                    </div>
